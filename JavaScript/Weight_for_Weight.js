...
function somme(number){
    ...
    for(let element of stringNumber){
      newSomme += parseInt(element);
    }
  ...
  function orderWeight(strng) {
    ...
    let arrayNum = strng.split(' ');
    
    let arrayValue = arrayNum.map(somme);
    
    let sortedArray = arrayNum.sort(newSort).join(' ');

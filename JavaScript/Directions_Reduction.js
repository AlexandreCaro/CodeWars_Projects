...
function dirReduc(arr){
    ...
    let dictionary = {"NORTH": "SOUTH", "SOUTH":"NORTH", "EAST":"WEST", "WEST":"EAST"};
...
Not all paths can be made simpler. The path ["NORTH", "WEST", "SOUTH", "EAST"] is not reducible. "NORTH" and "WEST", "WEST" and "SOUTH",
 "SOUTH" and "EAST" are not directly opposite of each other and can't become such. Hence the result path is itself : 
